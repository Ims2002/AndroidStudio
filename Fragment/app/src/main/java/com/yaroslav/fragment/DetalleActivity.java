...
public class DetalleActivity extends AppCompatActivity {
    static final String EXTRA_CONTACT = "com.yaroslav.fragment.EXTRA_CONTACT";
    static final String EXTRA_NAME = "com.yaroslav.fragment.EXTRA_NAME";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            //contact = new Contact(nameContact,surname1Contact,surname2Contact,birthContact,companyContact,emailContact,phone1Contact,phone2Contact,addressContact);

            Bundle bundle = new Bundle();
            bundle.putSerializable(FragmentDetalle.CONTACT_CONTACT,contact);
            ...
            //bun.putBundle(FragmentDetalle.CONTACT_CONTACT,bundle);
